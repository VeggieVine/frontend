          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className="border border-gray-200 rounded-lg overflow-hidden relative">
              <div className="absolute top-0 right-0 z-10 p-4">
                <Image src='/assets/image/logo.svg' width='150' height='150' alt='Logo' priority />
              </div>
              <div className="mt-20"> 
            ...
            <div>
              <h1 className='text-2xl font-semi bold mb-4'>{product.name}</h1>
              <p className='text-3xl font-bold mb-4'>Rp {product.price}</p>
              ...
              <div className="flex items-center mt-4">
                ...
                <button onClick={handleDecrement} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">
                  -
                </button>
                <span className="px-2">{quantity}</span>
                <button onClick={handleIncrement} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">
                  +
                </button>
